            ...
            <div className="lt-text-gray-500 max-w-none !p-8">
              ...
              <div className="space-y-5 leading-7">
                ...
                <p>
                  <Trans>
                    ...
                    BCharity (“we,” “our,” or “us”) collects, uses, and shares information about you in
                    connection with the website at bchrity.net”, as well as your rights and choices regarding
                    such information.
                  </Trans>
                </p>
                <p>
              ...
              <p className="leading-7">
                <Trans>
                  ...
                  compliance with applicable law, please contact us at privacy@bcharity.net
                </Trans>
              </p>
              {/* 10. Contact ends */}
            </div>
