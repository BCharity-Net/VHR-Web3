          ...
          <div className="max-w-3/4 relative mx-auto rounded-lg sm:w-2/4">
            <div className="lt-text-gray-500 max-w-none !p-8">
              ...
              <div className="space-y-5 leading-7">
                <p>
                  <Trans>
                    The website bcharity.net” (the “Site”) offers information, tools and services to you to
              ...
              <p className="leading-7">
                <Trans>Questions about the Terms should be sent to us at terms@bcharity.net</Trans>
              </p>
