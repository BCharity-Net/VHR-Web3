    ...
    >
      ...
      >
        {publication?.hidden ? (
          ...
          <>
            <PublicationBody publication={rootPublication as BCharityPublication} />
            {showActions && (
              <PublicationActions
                publication={rootPublication as BCharityPublication}
                electedMirror={feedItem?.electedMirror as ElectedMirror}
              />
            )}
            {showModActions && <ModAction publication={rootPublication as BCharityPublication} />}
          </>
        )}
      </div>
    </article>
