...
export const fuzzyTextFilterFn = (rows: Row<Data>[], id: number, filterValue: any) => {
...
export const greaterThanEqualToFn = (rows: Row<Data>[], id: number, filterValue: any) => {
...
export const lessThanEqualToFn = (rows: Row<Data>[], id: number, filterValue: any) => {
  return rows.filter((row: any) => {
    const rowValue = new Date(row.values[id])
    const filterDate = new Date(filterValue)
    return rowValue <= filterDate
...
export const getStatusFn = (rows: Row<Data>[], id: number, filterValue: any) => {
