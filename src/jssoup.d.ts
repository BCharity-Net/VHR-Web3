declare module 'jssoup' {
  ...
  export class SoupElement {
    ...
    constructor(parent?: SoupTag, previousElement?: SoupTag, nextElement?: SoupTag)
  ...
  export class SoupString extends SoupElement {
    constructor(text: string, parent?: SoupElement, previousElement?: SoupElement, nextElement?: SoupElement)
  ...
  export class SoupTag extends SoupElement {
    ...
    constructor(name: string, builder: TreeBuilder, attrs: { [attribute: string]: string })
    ...
    public find<T extends SoupElement>(name?: string, attrs?: Attributes, string?: string): T | undefined

    /** like find_all in BeautifulSoup */
    public findAll<T extends SoupElement>(name?: string, attrs?: Attributes, string?: string): T[]
    ...
    public findNextSiblings<T extends SoupElement>(name?: string, attrs?: Attributes, string?: string): T[]
